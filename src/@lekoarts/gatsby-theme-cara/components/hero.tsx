  ...
  <div sx={{ width: [`full`, `full`, `full`, `full`, `full`, `full`], textAlign: `left` }}>
    <div className={wrapper}>
      ...
      <p className={cx(text, halfSpacer)}>
        Written content that describes imagined spaces of this type is the fundamental medium used in this analysis.</p>
      <p className={text}>
        Eight core atmospheric narratives from the auto-fictional novel <span className={italic}>Territory of Light</span> written by the Japanese author Yuko Tsushima were adapted into corresponding short film chapters. These film chapters came into being through the interpretation and representation of the text with the help of architectural and artistic tools. The poetic depictions of everyday spaces found in the novel that previously only existed in written word can be phenomenologically traced in the film.
      </p>
    </div>
  </div>
)
